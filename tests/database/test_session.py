...
@pytest.mark.asyncio
async def test_close_disposes_engine(testing_manager: DatabaseSessionManager) -> None:
    await testing_manager.close()
    assert testing_manager.engine is None
    assert testing_manager._sessionmaker is None
